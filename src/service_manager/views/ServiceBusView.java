...
import service_manager.actions.DeleteServiceBusAction;
import service_manager.actions.OpenServiceBusAction;
import service_manager.types.BusinessService;
import service_manager.types.ServiceBus;

public class ServiceBusView extends ViewPart {
	private static final String LABEL_SEARCH_TEXT = "Nombre del ServiceBus: ";
	private static final String LABEL_SEARCH = "Administración de ServiceBus";

	public ServiceBusView() {
	}

	public static final String ID = "Service_Manager.views.serviceBusView";
	private Text text;
	...
	private void initContextMenu() {
		...
		menuMgr.addMenuListener(new IMenuListener() {
			...
			public void menuAboutToShow(IMenuManager manager) {
				OpenServiceBusAction open = new OpenServiceBusAction(treeViewer);
				open.setText("Abrir ServiceBus");
				DeleteServiceBusAction delete = new DeleteServiceBusAction(
						treeViewer);
				delete.setText("Eliminar ServiceBus");
				manager.add(open);
				manager.add(delete);
			}
		});
	...
	public void updateTree() {
		treeViewer.setInput(Activator.serviceManager.getServicebusList());
	}

	private void searchBusinessServices(String query) {
		Activator.getDefault();
		ArrayList<ServiceBus> input = Activator.serviceManager
				.searchServiceBus(query);
